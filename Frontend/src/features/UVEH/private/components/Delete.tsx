...
import { IconAlertTriangleFilled, IconArticle, IconCategory, IconFileText, IconLetterT, IconVirus } from "@tabler/icons-react"
...
export const Delete = ({ id, name, description, category, file }: UVEHData) => {
    ...
    const handleSubmit = async () => {
        try {
            setLoading(true);
            await remove?.(id)
            showSuccessModal("UVEH Eliminado", "UVEH fue eliminado correctamente")
        } catch (error: unknown) {
            Notify({
                type: "error",
                title: "Error al eliminar UVEH",
        ...
        <form onSubmit={form.onSubmit(handleSubmit)}>
            <Stack>
                ...
                <Alert
                    ...
                    content={
                        <List>
                            <List.Item>Se eliminara permanentemente el UVEH</List.Item>
