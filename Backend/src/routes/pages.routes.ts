import { deletePageController, getAllPagesController, getPageController, getPagesController, getPagesCountController, publishPageController, uploadPageImageController } from "@/controllers/pages.controller";
